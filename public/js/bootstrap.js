...
__webpack_require__(/*! ./general */ "./assets/js/general.js");
...
class Modal extends _base_component__WEBPACK_IMPORTED_MODULE_5__["default"] {
  ...
  _adjustDialog() {
    ...
    if ((!this._isBodyOverflowing && isModalOverflowing && !Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["isRTL"])()) || (this._isBodyOverflowing && !isModalOverflowing && Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["isRTL"])())) {
...
const AttachmentMap = {
  AUTO: 'auto',
  TOP: 'top',
  RIGHT: Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'left' : 'right',
  BOTTOM: 'bottom',
  LEFT: Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'right' : 'left'
}
...
class Tooltip extends _base_component__WEBPACK_IMPORTED_MODULE_7__["default"] {
  ...
  show() {
    ...
    const shadowRoot = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["findShadowRoot"])(this._element)
    ...
    const tipId = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["getUID"])(this.constructor.NAME)
    ...
    if (this.tip.classList.contains(CLASS_NAME_FADE)) {
      const transitionDuration = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["getTransitionDurationFromElement"])(this.tip)
  ...
  hide() {
    ...
    if (this.tip.classList.contains(CLASS_NAME_FADE)) {
      const transitionDuration = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["getTransitionDurationFromElement"])(tip)
  ...
  setElementContent(element, content) {
    ...
    if (typeof content === 'object' && Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isElement"])(content)) {
      if (content.jquery) {
        content = content[0]
      }
  ...
  _setListeners() {
    ...
    triggers.forEach(trigger => {
      if (trigger === 'click') {
        _dom_event_handler__WEBPACK_IMPORTED_MODULE_4__["default"].on(this._element, this.constructor.Event.CLICK, this.config.selector, event => this.toggle(event))
        ...
        _dom_event_handler__WEBPACK_IMPORTED_MODULE_4__["default"].on(this._element, eventIn, this.config.selector, event => this._enter(event))
        _dom_event_handler__WEBPACK_IMPORTED_MODULE_4__["default"].on(this._element, eventOut, this.config.selector, event => this._leave(event))
      }
    })
  ...
  static jQueryInterface(config) {
    return this.each(function () {
      let data = _dom_data__WEBPACK_IMPORTED_MODULE_3__["default"].get(this, DATA_KEY)
...
/*!*****************************************************!*\
  !*** ./node_modules/bootstrap/js/src/util/index.js ***!
  \*****************************************************/
/*! exports provided: getUID, getSelectorFromElement, getElementFromSelector, getTransitionDurationFromElement, triggerTransitionEnd, isElement, emulateTransitionEnd, typeCheckConfig, isVisible, isDisabled, findShadowRoot, noop, reflow, getjQuery, onDOMContentLoaded, isRTL, defineJQueryPlugin */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 0:
/*!***************************************************************!*\
  !*** multi ./assets/js/bootstrap.js ./assets/scss/index.scss ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
